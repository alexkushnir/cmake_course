...
TEST_CASE_METHOD(RemoteMessageTest, "NoArguments", "[RemoteMessage]")
{
...
TEST_CASE_METHOD(RemoteMessageTest, "EmptyMessage", "[RemoteMessage]")
{
	const std::string testString{ "" };
    ...
    REQUIRE(rlm.GetLogMessageLength() == testString.size());
    REQUIRE(rlm.GetLogText() == testString);
}

TEST_CASE_METHOD(RemoteMessageTest, "NoKeyForArgs", "[RemoteMessage]")
{
...
TEST_CASE_METHOD(RemoteMessageTest, "IncompatibleKeys", "[RemoteMessage]")
{
